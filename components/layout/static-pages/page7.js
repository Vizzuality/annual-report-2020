...
But we can’t solve the world’s problems alone. That’s why we work with, and support, the organisations and companies who are leading the change we want to see in the world. Organisations like the World Resources Institute and the Stockholm Environment Institute who have important data, expertise and knowledge that needs to be seen and used. <a className="-strong -underline" href="https://medium.com/vizzuality-blog/how-we-made-resource-watch-even-easier-to-use-37c21550a8a9" target="_blank">We work with them to make sure it is.</a></p>
      ...
      <video muted playsinline autoplay loop width="100%" height="auto" src="/videos/workingTogether.mp4" type="video/mp4" />
