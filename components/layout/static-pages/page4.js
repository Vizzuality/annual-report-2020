const Page4 = () => (
  <div className="l-static-page">
    ...
    <div className="col-2">
      ...
      />
      <p className="-caption"><a className="-strong -underline" href="https://trase.earth/data" target="_blank">Trase </a> helped flag inconsistent zero-deforestation-commitment reports in beef exports from the Amazon Rainforest to the UK, even when these represented a minimal proportion of the total production.</p>
