const Page2 = () => (
  <div className="l-static-page">
    ...
    <div className="col-2">
      ...
      <p className="-caption">Wildlands and semi-natural lands have decreased globally since the 18th century. <a className="-strong -underline" href="https://medium.com/vizzuality-blog/where-the-wild-things-arent-7f3d3a994cca" target="_blank" rel="noopener noreferrer">There is however room for hope.</a></p>
