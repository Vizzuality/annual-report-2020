const Page2 = () => (
  <div className="l-static-page">
    ...
    <div className="col-2">
      ...
      <p className="-caption">Wildlands and semi-natural lands have decreased globally since the 18th century. We used <a className="-strong -underline" href="https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1466-8238.2010.00540.x" target="_blank" rel="noopener noreferrer">data</a> to visualise where wilderness loss has occurred, and where it could be restored. <a className="-strong -underline" href="https://medium.com/vizzuality-blog/where-the-wild-things-arent-7f3d3a994cca" target="_blank" rel="noopener noreferrer">There is always room for help.</a></p>
