const Page1 = () => (
  <div className="l-static-page">
    ...
    <div className="col-2">
      ...
      <p className="-caption">In 2020, we invested our collective effort into projects at the intersection of climate change, biodiversity, and social inequality.</p>
