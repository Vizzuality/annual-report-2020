const Page3 = () => (
  <div className="l-static-page">
    <div className="col-1">
      <p>Food insecurity is just one example of the profound social impacts a water crisis can have. In 2020, we worked on <a className="-strong -underline" className="-strong -underline" href="https://www.wri.org/aqueduct" target="_blank">Aqueduct</a>, a platform that identifies and evaluates water risks worldwide. The tool can guide decisions on how to manage water resources more sustainably. </p>
      ...
      <p>Launched in 2020, we can use the <a className="-strong -underline" href="https://soilsrevealed.org/" target="_blank">platform’s data</a> to see the historical change in soil carbon over time and learn which land management methods would keep the most carbon in the ground. In some places, the increase in carbon stock could be more than 20 tonnes per hectare.</p>
    </div>
    <div className="col-2">
