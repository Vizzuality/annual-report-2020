const Page6 = () => (
  <div className="l-static-page">
    ...
    <div className="col-2">
      ...
      <p className="-caption">Global travel bans in 2020 impacted the livelihoods of communities relying on wildlife tourism in Africa, and consequently personal and governmental conservation efforts. (Data Sources: Hotel and lodge density, OpenStreetMaps; Protected Areas, WDPA).</p>
      <p>The <a className="-strong -underline" href="https://www.covid19tracker.africa/" target="_blank">Covid-19 Tracker</a> by FinMark Trust tracks themes including health and risk behaviours, food security, income, work and job security, personal safety concerns, and access to government and community support. With this information, we can understand the impact of covid on people’s health and wellbeing, and identify what support is most needed.</p>
      <p>Meanwhile, an <a className="-strong -underline" href="https://luchoffmanninstitute.org/securing-the-future-of-nature-based-tourism-in-africa-a-collaborative-platform/" target="_blank">Africa-based Collaborative Platform</a> incubated by The Luc Hoffmann Institute is responding to the impact the pause in global tourism had on conservation. The platform aims to support marginalised rural community stakeholders who are the custodians of the landscapes and wildlife on which tourism depends, while amplifying existing fundraising efforts.</p>
    </div>
  </div>
);
