  ...
  >
    <defs>
      ...
      <symbol id="icon-download" viewBox="0 0 32 32">
        <path fill="none" stroke="#fff" style={{ stroke: "var(--color1, #fff)" }} strokeLinejoin="round" strokeLinecap="round" strokeMiterlimit="4" stroke-width="2.1818" d="M16.001 21.946v-11.901"></path>
        <path fill="none" stroke="#fff" style={{ stroke: "var(--color1, #fff)" }} strokelinejoin="round" strokeLinecap="round" strokeMiterlimit="4" stroke-width="2.1818" d="M20.96 16.988l-4.959 4.959-4.959-4.959"></path>
        <path fill="none" stroke="#fff" style={{ stroke: "var(--color1, #fff)" }} strokelinejoin="round" strokeLinecap="round" strokeMiterlimit="4" stroke-width="2.1818" d="M29.886 15.996c0 7.668-6.216 13.884-13.884 13.884s-13.884-6.216-13.884-13.884c0-7.668 6.216-13.884 13.884-13.884s13.884 6.216 13.884 13.884z"></path>
      </symbol>
      ...
      <symbol id="icon-close" viewBox="0 0 32 32">
        ...
        <path fill="none" stroke="#000" style={{ stroke: "var(--color2, #000)" }} strokeLinejoin="round" strokeLinecap="round" strokeMiterlimit="4" stroke-width="1.3714" d="M11.429 11.429l9.143 9.143"></path>
        <path fill="none" stroke="#000" style={{ stroke: "var(--color2, #000)" }} strokeLinejoin="round" strokeLinecap="round" strokeMiterlimit="4" stroke-width="1.3714" d="M11.429 20.571l9.143-9.143"></path>
      </symbol>
    </defs>
  </svg>
);
